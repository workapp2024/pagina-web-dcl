...
export function VehicleSelector() {
  return <section id="vehiculos" className="mx-auto max-w-7xl scroll-mt-24 px-4 py-14 sm:px-6 lg:px-8">
    <div className="mb-7 max-w-2xl">
      ...
      <p className="mt-3 text-sm leading-6 text-zinc-300">Elegí el tipo de vehículo. En el catálogo podés refinar por categoría y conector. Para Alta o Baja, consultá la compatibilidad de tu vehículo.</p>
    </div>
    <VehicleCategories />
